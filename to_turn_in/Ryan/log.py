...
# This function is the orchestrator to call and collect results from logistic regression.
def main(path):
    ...
    print('\n---------------THESE ARE THE RESULTS FOR THE LOGISTIC REGRESSION---------------')
