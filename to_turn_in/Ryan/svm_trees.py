...
regularizationHyperParams=[10, 1, 0.1, 0.01, 0.001, 0.0001, 0.00001]

# This function is the orchestrator to call and collect results from svm over trees.
def main():
    ...
    print('\n---------------THESE ARE THE RESULTS FOR THE STOCHASTIC GRADIENT DESCENT SVM OVER TREES---------------')
